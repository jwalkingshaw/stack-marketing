            ...
            <div className="grid gap-10 lg:grid-cols-12 lg:items-center xl:gap-14">
              <div className="marketing-reveal lg:col-span-5">
                ...
                <div className="mt-10 flex flex-col gap-3 sm:flex-row">
                  ...
                  <a href={salesHref} className="inline-flex items-center justify-center border border-[var(--color-border-strong)] px-7 py-3.5 text-sm font-semibold text-[var(--color-foreground)] transition-colors hover:border-[var(--color-accent)]">
                    Talk to sales
                  </a>
                </div>
          ...
          <div className="mx-auto grid max-w-7xl gap-10 border-t border-[var(--color-border)] pt-12 lg:grid-cols-[1fr_auto] lg:items-end">
            ...
            <div className="flex flex-col gap-3 lg:items-end">
              <Link
                ...
                className="marketing-primary-button inline-flex items-center justify-center gap-2 border border-[var(--color-primary)] bg-[var(--color-primary)] px-8 py-4 text-base font-bold transition-colors hover:bg-[var(--color-primary-hover)]"
              >
                Start sandbox
                <ArrowRight size={17} />
              </Link>
              <a href={salesHref} className="inline-flex items-center justify-center border border-[var(--color-border-strong)] px-8 py-4 text-base font-semibold text-[var(--color-foreground)] transition-colors hover:border-[var(--color-accent)]">
                Talk to sales
              </a>
            </div>
          </div>
