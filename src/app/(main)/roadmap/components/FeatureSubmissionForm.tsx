  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <button
        ...
        className="marketing-primary-button h-10 w-full rounded-lg bg-[var(--color-primary)] px-4 py-2 text-sm font-medium hover:bg-[var(--color-primary-hover)] disabled:cursor-not-allowed disabled:opacity-60"
      >
